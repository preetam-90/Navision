    ...
    <>
      ...
      >
        <p className="text-base text-muted-foreground">
          Bhaiflix is a free online movie and TV show streaming website that
          allows users to watch content sourced from third parties. Bhaiflix
        ...
        <p className="text-base text-muted-foreground">
          Bhaiflix has no control over the content quality, availability,
          copyright, legality or validity of the third party material viewed via
          the site. Bhaiflix cannot be held responsible for any streaming
        ...
        <p className="text-base text-muted-foreground">
          The operators of Bhaiflix make no warranties or representations
          ...
          Bhaiflix, you agree that access is provided "as is" at your own
          risk.
        </p>
        <div className="text-base text-muted-foreground">
          <p>Copyright Infringement:</p>
          Bhaiflix respects the intellectual property rights of others. Users
          are prohibited from using Bhaiflix to engage in copyright
          infringement or the unauthorized distribution of copyrighted content.
          Bhaiflix will promptly remove or disable access to any infringing
          content upon receipt of proper notification from the copyright holder.
        </div>
        <div className="text-base text-muted-foreground">
          <p>No Endorsement:</p>
          <p>
            The content accessible through Bhaiflix does not constitute an
        ...
        <div className="text-base text-muted-foreground">
          ...
          <p>
            Bhaiflix does not knowingly collect or distribute content
            considered obscene or harmful to minors as defined by applicable
            law. However, Bhaiflix has no control over third party content and
            some material accessible through Bhaiflix may be inappropriate for
        ...
        <div className="text-base text-muted-foreground">
          <p>No Warranties:</p>
          <p>
            Bhaiflix provides access to third party content on an "as is"
        ...
        <div className="text-base text-muted-foreground">
          ...
          <p>
            In no event shall Bhaiflix be liable for any direct, indirect,
            ...
            hold harmless Bhaiflix and its operators from any claims arising
